...
export default function contacts(){
    ...
    <div className={styles.card}>
          ...
          <div className={styles.cardDescription}>
            <h3 style={{fontSize:"1rem", fontFamily:"arial",padding:"0.5rem"}}>You can reach us through email <strong style={{color:"blue"}}>greenprinttours@gmail.com</strong> or through our social media pages.</h3>
